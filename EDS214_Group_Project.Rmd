...
K_all <- ggplot(data=Joined, aes(x=monthyear, y=meanK)) + 
  ...
  geom_vline(xintercept = 1989.6, color = "black", size = 0.5) +
   annotate("text", x = 1993, y = 1.8, label = "hurricane Hugo", color = "black", size = 3)
K_all
```
...
N_all <- ggplot(data=Joined, aes(x=monthyear, y=meanN)) + 
  ...
  labs(x = "Years",
       y = y2) + 
  geom_vline(xintercept = 1989.6, color = "black", size = 0.5) +
  annotate("text", x = 1993, y = 700, label = "hurricane Hugo", color = "black", size = 3)
...
NH_all <- ggplot(data=Joined, aes(x=monthyear, y=meanNH)) + 
  ...
  labs(x = "Years",
       y = y3) + 
  geom_vline(xintercept = 1989.6, color = "black", size = 0.5) +
  annotate("text", x = 1993, y = 125, label = "hurricane Hugo", color = "black", size = 3)
